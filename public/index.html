        ...
        messages: [
          {
            ...
            - keyPoints: 회의의 핵심 내용을 Markdown 불릿 포인트(- ) 형식으로 요약. (※ 매우 중요: 절대 5줄(5개 항목)을 초과하지 말 것. 무조건 1~5줄 이하로 작성)
            - fullSummary: 회의 전체 내용을 빠짐없이 요약한 단일 문자열.
              ※ 매우 중요: 대주제와 소주제에 맞게 들여쓰기(공백 2칸)를 활용한 계층형 마크다운 리스트(- )로 작성할 것. 
              ※ 매우 중요: 억지로 '~함', '~임'으로 끝내지 말고, 'keyPoints(핵심 요약)'에서 사용한 것과 완전히 동일한 자연스러운 명사형 종결이나 요약 문체를 적용할 것.
